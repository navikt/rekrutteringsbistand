/**
 *  https://github.com/navikt/internarbeidsflatedecorator?tab=readme-ov-file#konfigurasjon
 */
export interface DecoratorProps {
    ...
    onEnhetChanged: (enhet?: Enhet) => void; // Kalles når enheten endres
    ...
    hotkeys?: any; // Konfigurasjon av hurtigtaster
