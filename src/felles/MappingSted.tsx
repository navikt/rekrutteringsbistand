...
const stedMapping2024 = new Map<string, string[]>([
    ...
    ['Alta.NO56.5403', ['Alta.NO20.2012', 'Alta.NO54.5403']],
    [
        'Hammerfest.NO56.5406',
        ['Hammerfest.NO20.2004', 'Kvalsund.NO20.2017', 'Hammerfest.NO54.5406'],
    ],
    ['Vadsø.NO56.5405', ['Vadsø.NO20.2003', 'Vadsø.NO54.5405']],
    ['Vardø.NO56.5404', ['Vardø.NO20.2002', 'Vardø.NO54.5404']],
    ['Sør-Varanger.NO56.5444', ['Sør-Varanger.NO20.2030', 'Sør-Varanger.NO54.5444']],
    ['Tana.NO56.5441', ['Tana.NO20.2025', 'Tana.NO54.5441']],
    ['Berlevåg.NO56.5440', ['Berlevåg.NO20.2024', 'Berlevåg.NO54.5440']],
    ['Båtsfjord.NO56.5443', ['Båtsfjord.NO20.2028', 'Båtsfjord.NO54.5443']],
    ['Nordkapp.NO56.5435', ['Nordkapp.NO20.2019', 'Nordkapp.NO54.5435']],
    ['Porsanger.NO56.5436', ['Porsanger.NO20.2020', 'Porsanger.NO54.5436']],
    ['Karasjok.NO56.5437', ['Karasjok.NO20.2021', 'Karasjok.NO54.5437']],
    ['Kautokeino.NO56.5430', ['Kautokeino.NO20.2011', 'Kautokeino.NO54.5430']],
    ['Lebesby.NO56.5438', ['Lebesby.NO20.2022', 'Lebesby.NO54.5438']],
    ['Gamvik.NO56.5439', ['Gamvik.NO20.2023', 'Gamvik.NO54.5439']],
    ['Hasvik.NO56.5433', ['Hasvik.NO20.2015', 'Hasvik.NO54.5433']],
    ['Måsøy.NO56.5434', ['Måsøy.NO20.2018', 'Måsøy.NO54.5434']],
    ['Nesseby.NO56.5442', ['Nesseby.NO20.2027', 'Nesseby.NO54.5442']],
    ['Loppa.NO56.5432', ['Loppa.NO20.2014', 'Loppa.NO54.5432']],
