            ...
            <Alert className={css.manglerØnsketBanner} fullWidth variant="info">
                <div className={css.innhold}>
                    <div>
                        ...
                        <BodyLong>
                            For å få bedre stillinger, hør med kandidaten om vedkommende kan legge
                            til ønsket jobbsted i CV-en sin. I mellomtiden viser vi deg resultater
                            ut i fra kommunen der kandidaten bor.
                        </BodyLong>
                    </div>
                    <Button
                        size="small"
